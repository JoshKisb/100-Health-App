...
const Loader = () => {
    ...
    return (
        <div>
            <div className="loader-page">
                ...
                <div className="vertical-centered-box">
                    <div className="content">
                        ...
                        <div style={{fontSize: '16px', color: '#FFFFFF'}}>SITES SI-Validation Suite</div>
            ...
            <div className="powered-by" style={{fontSize: '16px', color: '#FFFFFF'}}>Powered By AICONNECT-0777108323</div>
        </div>
    );
};
